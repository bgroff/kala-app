...
EMAIL_USE_TLS = get_env_variable('KALA_EMAIL_USE_TLS', default=False)
EMAIL_USE_SSL = get_env_variable('KALA_EMAIL_USE_SSL', default=False)
...
EMAIL_TIMEOUT = get_env_variable('KALA_EMAIL_TIMEOUT', default=False)
